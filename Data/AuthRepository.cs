...
namespace dotnetFun.API.Data
{
    public class AuthRepository : IAuthRepository
    {
        ...
        {
            using (var hmacEncrypt = new System.Security.Cryptography.HMACSHA512(passwordSalt))
            {
                var computedHash = hmacEncrypt.ComputeHash(System.Text.Encoding.UTF8.GetBytes(password));
